...
$$ {#eq-ar-ar1-noncausal}
Using the same arguments as in the proof of [Proposition 10.1](10-ar.qmd#sec-ar-ar1-solutions), one can check that this converges absolutely, and that $(X_t)$ is stationary and satisfies @eq-ar-ar1.
...
\end{split}
$$
Uniqueness can be derived in a similar manner to Proposition 10.1. $\Box$
