...
In view of the data's periodic nature, it seems to make sense to fit a [signal plus noise model](10-stationary.qmd#sec-stationary-examples-signal-plus-noise) of the form
$$
