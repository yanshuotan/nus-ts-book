...
*Proof*.
The proof is similar to that of Theorem 11.4 and Proposition 12.1 and is henced omitted.
...
Note that @eq-arma-forecast-variance is in terms of the $\psi_j$'s, which can be calculated via Proposition 12.3.
