...
In @fig-intro-pm25, we plot PM2.5 concentration levels in Beijing, measured hourly, in 2011. [^5]
...
#| message: FALSE
#| warning: FALSE
#| fig-cap: Hourly PM2.5 concentration levels in Beijing in 2011.
...
Time series data is also prevalent in the physical sciences and engineering, in particular, when analyzing dynamical systems.
...
Secondly, despite these differences, it seems apparent that most plots are not *totally random*, and some time-based structure can be extracted from then.
...
In this section, we discuss several categories of goals researchers have when performing analysis of time series data.
